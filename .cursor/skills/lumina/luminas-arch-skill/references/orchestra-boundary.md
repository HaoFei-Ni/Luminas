...
1. `luminas-arch-skill` — identity, non-goals, layering, source tree, Orchestra override
2. `eng-standard-skill` — coding, build, CI-grade tests, GPU memory tiers
3. `research-skill` — experiment design, canonical lossless definition, statistics, paper structure
...
| `ml-paper-writing` | NeurIPS / ICML / ICLR prose, citation verification, LaTeX | Override `research-skill` section order or lossless reporting |
